...
import { Instagram, Bell, Lock, User, Palette, CheckCircle2, XCircle } from "lucide-react"
...
export default function SettingsPage() {
  ...
  const handleConnectInstagram = () => {
    ...
    toast({
      title: instagramConnected ? "Instagram Disconnected" : "Instagram Connected",
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-secondary rounded-lg">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    {instagramConnected ? (
                      <>
                        ...
                        <span className="text-sm text-muted-foreground">@johndoe_official</span>
                      </>
                    ) : (
                      <>
              ...
              <Badge
                ...
                className={instagramConnected ? "bg-chart-3 text-white" : "bg-secondary text-secondary-foreground"}
              >
